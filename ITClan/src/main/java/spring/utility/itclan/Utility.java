...
public class Utility {
	   ...
	   * @return 댓글개수
	   */
//	  public static int rcountI(int imgno,RImgDAO rdao){
...
//	  
	   ...
	   * @return 페이징 생성 문자열
	   */ 
	   public static String paging2(int totalRecord, int nPage, int recordPerPage,String url,int imgno,int nowPage, String col, String word){ 
...
//	      str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
		   ...
		   if (nowGrp >= 2){ 
			   str.append("<span class='span_box_1'><A href='./"+url+"?nowPage="+nowPage+"&col="+col+"&word="+word+"&imgno="+imgno+"&nPage="+_nowPage+"'>이전</A></span>"); 
		   } 
		   ...
		   for(int i=startPage; i<=endPage; i++){ 
			   ...
			   if (nPage == i){ 
				   ...
				   str.append("<span class='span_box_1'><A href='./"+url+"?nowPage="+nowPage+"&col="+col+"&word="+word+"&imgno="+imgno+"&nPage="+i+"'>"+i+"</A></span>");   
			   } 
		   } 
		   
		   _nowPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동 
		   if (nowGrp < totalGrp){ 
			   str.append("<span class='span_box_1'><A href='./"+url+"?nowPage="+nowPage+"&col="+col+"&word="+word+"&imgno="+imgno+"&nPage="+_nowPage+"'>다음</A></span>"); 
		   } 
		   str.append("</DIV>"); 
