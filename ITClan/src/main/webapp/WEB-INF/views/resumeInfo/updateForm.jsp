...
<script type="text/javascript">
	function input(f) {
		...
		if (f.education[2].checked == true || f.education[3].checked == true
				|| f.education[4].checked == true
				|| f.education[5].checked == true) {
		...
		<table border="1">
			...
			<tr>
				...
				<td colspan="3">
					...
					${personalmemberdto.birth.substring(4,6) }일</td>
			</tr>
			...
			<tr>
				...
				<c:choose>
					<c:when
						test="${resumeinfodto.disableGrade.substring(0,2)=='장애' && resumeinfodto.disableGrade.substring(3,4)=='1'}">
						...
						</select> <input style="margin-left: 15px" type="radio" id="normal"
					...
					<c:when
						...
						<td><input type="radio" id="disable" name="disableGrade"
							...
							name="disableGrade" value="비장애" checked="checked">비장애</td>
					</c:when>
					<c:when
					...
					<c:when
						test="${resumeinfodto.disableGrade.substring(0,2)=='장애' && resumeinfodto.disableGrade.substring(3,4)=='5'}">
						<td><input type="radio" id="disable" name="disableGrade"
							value="장애" checked="checked">장애 <select id="grade"
							name="disableGrade">
								<option value="----">----
					...
					<div id="school" style="display: none;">
							...
							<table border="1" style="border-collapse: collapse;">
								...
								<tr>
									...
									</select> ~ <input id="grayear" type="month" name="termTime"
										max="2016-12" min="1910-01">. <select name="termTime"
										id="selgra">
						...
						<tr>
							...
							<td><input id="entyear" type="month" name="termTime"
								...
								max="2016-12" min="1910-01">. <c:choose>
									...
									<c:when
										test="${resumeinfodto.termTime.substring(termTimelast-2,termTimelast)=='예정'}">
										<select name="termTime" id="selgra">
											<option value="졸업">졸업</option>
									...
									<c:when
										test="${resumeinfodto.termTime.substring(termTimelast-2,termTimelast)=='휴학'}">
										<select name="termTime" id="selgra">
											<option value="졸업">졸업</option>
											<option value="졸업예정">졸업예정</option>
									...
									<c:when
										test="${resumeinfodto.termTime.substring(termTimelast-2,termTimelast)=='중퇴'}">
										<select name="termTime" id="selgra">
											<option value="졸업">졸업</option>
											<option value="졸업예정">졸업예정</option>
											<option value="휴학">휴학</option>
									...
									<c:when
										test="${resumeinfodto.termTime.substring(termTimelast-2,termTimelast)=='수료'}">
										<select name="termTime" id="selgra">
											<option value="졸업">졸업</option>
											<option value="졸업예정">졸업예정</option>
											<option value="휴학">휴학</option>
								...
								<tr id="gPA">
									...
									<td><input id="textgpa" type="text" name="gPA"
										...
										style="width: 40px;"> / <c:choose>
											...
											<c:when
												test="${resumeinfodto.GPA.substring(GPAlast-3,GPAlast)=='4.3'}">
												<select name="gPA" id="selgPA">
													<option value="4.5">4.5</option>
											...
											<c:when
												test="${resumeinfodto.GPA.substring(GPAlast-3,GPAlast)=='4.0'}">
												<select name="gPA" id="selgPA">
													<option value="4.5">4.5</option>
													<option value="4.3">4.3</option>
											...
											<c:when
												test="${resumeinfodto.GPA.substring(GPAlast-3,GPAlast)=='100'}">
												<select name="gPA" id="selgPA">
													<option value="4.5">4.5</option>
													<option value="4.3">4.3</option>
													<option value="4.0">4.0</option>
		...
		<div style="width: 960px; margin: auto;">
			...
			<table border="1">
				<tr>
					...
					<c:choose>
						<c:when
							test="${resumeinfodto.employmentType.substring(0,2)=='정규'}">
							<td id="emp"><input type="radio" name="employmentType"
								value="정규직" checked="checked">정규직&nbsp;&nbsp; <input
								type="radio" name="employmentType" value="계약직">계약직&nbsp;&nbsp;
						...
						<c:when
							test="${resumeinfodto.employmentType.substring(0,2)=='계약'}">
							<td id="emp"><input type="radio" name="employmentType"
								value="정규직">정규직&nbsp;&nbsp; <input type="radio"
								name="employmentType" value="계약직" checked="checked">계약직&nbsp;&nbsp;
								<input type="radio" name="employmentType" value="병역특례">병역특례&nbsp;&nbsp;
								<input type="radio" name="employmentType" value="프리랜서">프리랜서&nbsp;&nbsp;
								<input type="radio" name="employmentType" value="헤드헌팅">헤드헌팅&nbsp;&nbsp;
								<input type="radio" name="employmentType" value="파견대행">파견대행&nbsp;&nbsp;
						...
						<c:when
							test="${resumeinfodto.employmentType.substring(0,2)=='병역'}">
							<td id="emp"><input type="radio" name="employmentType"
								value="정규직">정규직&nbsp;&nbsp; <input type="radio"
								name="employmentType" value="계약직">계약직&nbsp;&nbsp; <input
								type="radio" name="employmentType" value="병역특례"
						...
						<c:when
							test="${resumeinfodto.employmentType.substring(0,2)=='프리'}">
							<td id="emp"><input type="radio" name="employmentType"
								value="정규직">정규직&nbsp;&nbsp; <input type="radio"
								name="employmentType" value="계약직">계약직&nbsp;&nbsp; <input
						...
						<c:when
							test="${resumeinfodto.employmentType.substring(0,2)=='헤드'}">
							<td id="emp"><input type="radio" name="employmentType"
								value="정규직">정규직&nbsp;&nbsp; <input type="radio"
								name="employmentType" value="계약직">계약직&nbsp;&nbsp; <input
								type="radio" name="employmentType" value="병역특례">병역특례&nbsp;&nbsp;
						...
						<c:when
							test="${resumeinfodto.employmentType.substring(0,2)=='파견'}">
							<td id="emp"><input type="radio" name="employmentType"
								value="정규직">정규직&nbsp;&nbsp; <input type="radio"
								name="employmentType" value="계약직">계약직&nbsp;&nbsp; <input
								type="radio" name="employmentType" value="병역특례">병역특례&nbsp;&nbsp;
				...
				<tr>
					...
					<c:choose>
						<c:when test="${resumeinfodto.exSalary.substring(0,2)=='14'}">
							<td><select id="selsalary" name="exSalary">
				...
				<tr>
					...
					<c:choose>
						<c:when test="${resumeinfodto.exArea.substring(0,2)=='서울'}">
							<td><select id="selarea" name="exArea">
							...
							</select> <input id="textarea" type="text" name="exArea"
								value="${resumeinfodto.exArea.substring(4,6)}"></td>
						</c:when>
				...
				<tr>
					<th>지원분야</th>
					<td><input id="textfield" type="text" name="exField"
						value="${resumeinfodto.exField}"></td>
				</tr>
			</table>
		</div>
